      ...
      <div className="flex items-center justify-center mt-[100px]">
        <div className="flex  bg-slate-500 w-[800px] flex-row rounded-xl">
          ...
          <div className="flex flex-row items-center justify-center ml-[100px] ">
            ...
            <button className=" mt-3 text-lg text-neutral-200 font-bold hover:underline">{followers}</button>
            </div>
            ...
            <button className="ml-20 mt-3 text-lg text-neutral-200 font-bold hover:underline">{following}</button>
            </div>
          </div>
